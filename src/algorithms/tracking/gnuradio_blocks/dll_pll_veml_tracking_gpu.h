/*!
 * \file dll_pll_veml_tracking_gpu.h
...
#ifndef GNSS_SDR_DLL_PLL_VEML_TRACKING_GPU_H
#define GNSS_SDR_DLL_PLL_VEML_TRACKING_GPU_H
...
class Gnss_Synchro;
class dll_pll_veml_tracking_gpu;

using dll_pll_veml_tracking_gpu_sptr = gnss_shared_ptr<dll_pll_veml_tracking_gpu>;
 ...
 */
class dll_pll_veml_tracking_gpu : public gr::block
{
public:
    ~dll_pll_veml_tracking_gpu() override;
...
private:
    friend dll_pll_veml_tracking_gpu_sptr dll_pll_veml_make_tracking_gpu(const Dll_Pll_Conf &conf_);
    explicit dll_pll_veml_tracking_gpu(const Dll_Pll_Conf &conf_);
    ...
    cuda_multicorrelator_real_code d_multicorrelator_gpu;
    cuda_multicorrelator_real_code d_correlator_data_gpu;  // for data channel
...
/** \} */
/** \} */
#endif  // GNSS_SDR_DLL_PLL_VEML_TRACKING_GPU_H
